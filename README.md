...
- [Valet](https://github.com/square/Valet.git)
...
- [Hero](https://github.com/HeroTransitions/Hero.git)
- [Spring](https://github.com/MengTo/Spring.git)
- [ViewAnimator](https://github.com/marcosgriselli/ViewAnimator.git)
...
- [CareKit](https://github.com/carekit-apple/CareKit.git)
...
- [CYLTabBarController](https://github.com/ChenYilong/CYLTabBarController.git)

## 控件

- [TextFieldEffects](https://github.com/raulriera/TextFieldEffects.git)
...
- [SwifterSwift](https://github.com/SwifterSwift/SwifterSwift.git)
- [DuckDuck](https://github.com/xxwang/DuckDuck.git)